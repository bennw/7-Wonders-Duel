...
using namespace Seven_Wonders;
	...
	const std::string Seven_Wonders::cardName[85] =
	{
	...
	const int Seven_Wonders::cardAge[85] =
	{
		AGE_1, // lumber yard
		AGE_1, // logging camp
		AGE_1, // clay pool
	...
	const int Seven_Wonders::cardType[85] =
	{
	...
	const int Seven_Wonders::coinCost[85] =
	{
		0, // lumber yard
		1, // logging camp
		0, // clay pool
	...
	const int Seven_Wonders::woodCost[85] =
	{
		0, // lumber yard
		0, // logging camp
		0, // clay pool
	...
	const int Seven_Wonders::stoneCost[85] =
	{
		0, // lumber yard
		0, // logging camp
		0, // clay pool
	...
	const int Seven_Wonders::clayCost[85] =
	{
		0, // lumber yard
		0, // logging camp
		0, // clay pool
	...
	const int Seven_Wonders::papyrusCost[85] =
	{
		0, // lumber yard
		0, // logging camp
		0, // clay pool
	...
	const int Seven_Wonders::glassCost[85] =
	{
		0, // lumber yard
		0, // logging camp
		0, // clay pool
	...
	const int Seven_Wonders::linkValues[85] =
	{
	...
	const int Seven_Wonders::linkValues2[85] =
	{
		NOLINKVALUE, // lumber yard
		NOLINKVALUE, // logging camp
		NOLINKVALUE, // clay pool
